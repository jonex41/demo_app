...
class SucessWidget extends StatefulWidget {
  ...
  const SucessWidget(this.title, this.message, {super.key});

  @override
  State<SucessWidget> createState() => _SuccessModalState();
}

class _SuccessModalState extends State<SucessWidget> {
  @override
