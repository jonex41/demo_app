...
class ChipReferralController extends GetxController {
  ...
  final chipsAgentPhoneNoController = TextEditingController();
  final houseNoController = TextEditingController();
  final householdNoController = TextEditingController();
  final nameOfHouseHoldHeadController = TextEditingController();
  final wardController = TextEditingController();
  final settlementController = TextEditingController();
  final clientAgeController = TextEditingController();
