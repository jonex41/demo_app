...
@RoutePage()
class ChipsReferralListScreen extends StatefulWidget {
  const ChipsReferralListScreen({super.key});

  @override
  State<ChipsReferralListScreen> createState() =>
      _ChipsReferralListScreenState();
}

class _ChipsReferralListScreenState extends State<ChipsReferralListScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            15.height,
            _buildSectionTitle("List of CHIPS referred"),
