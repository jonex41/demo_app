class NigerianStatesAndLGA {
  ...
  static List<String> getAllNigerianLGAs() {
    _allLGAs.sort();
    return _allLGAs;
  }

  static List<String> getStateLGAs(String state) {
    int stateIndex = allStates.indexOf(state);
    switch (NigerianStates.values[stateIndex]) {
      ...
      case NigerianStates.fct:
        return abujaLGAs;
      case NigerianStates.selectAState:
        return [];
    }
  }
}
