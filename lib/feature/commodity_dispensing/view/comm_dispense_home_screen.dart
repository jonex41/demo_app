...
@RoutePage()
class CommDispenseHomeScreen extends StatefulWidget {
  const CommDispenseHomeScreen({super.key});

  @override
  State<CommDispenseHomeScreen> createState() => _CommDispenseHomeScreenState();
}
