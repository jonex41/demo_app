...
class CommDispenseDashboardScreen extends StatefulWidget {
  ...
  @override
  State<CommDispenseDashboardScreen> createState() =>
      _CommDispenseDashboardScreenState();
}

class _CommDispenseDashboardScreenState
    extends State<CommDispenseDashboardScreen> {
  @override
