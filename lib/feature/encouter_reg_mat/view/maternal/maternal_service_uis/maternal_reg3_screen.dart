...
@RoutePage()
class MaternalReg3Screen extends StatefulWidget {
  const MaternalReg3Screen({super.key});

  @override
  State<MaternalReg3Screen> createState() => _IEVDataScreen1State();
}

class _IEVDataScreen1State extends State<MaternalReg3Screen> {
  final controller =
            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                ...
                children: [
                  ...
                  MyDropDownWidget(
                    onChange: (value) {},
                    titile: "Danger signs identified?",
                  ...
                  _myMultiPicker(
                    context,
                    ["ANC", "Danger Signs", "Delivery", "PNC (Postnatal Care)"],
                    "Referral(Tick (✓) referrals made during pregnancy and postnatal period)",
                    (value) {
                  ...
                  Align(
                    ...
                    child: AppElevatedButton(
                      ...
                      text: 'Next',
                      onPressed: () {
                        appRoute.push(const MaternalReg4Route());
