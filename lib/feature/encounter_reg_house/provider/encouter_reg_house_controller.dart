...
class EncouterRegHouseController extends GetxController {
  ...
  final consellingWashController = TextEditingController();
  final counsellingAdolHealthController = TextEditingController();
  final counsellingFamilyController = TextEditingController();
  final counsellingDiseasePrevMalariaController = TextEditingController();
  final counsellingDiseasePreTuberController = TextEditingController();
  ...
  final searchTextController = TextEditingController();
    ...
    SearchModel(title: "Mr Foo"),
    SearchModel(title: "Usman Fori"),
    SearchModel(title: "Muhammed"),
    SearchModel(title: "Hauwa Abdullahi Sani"),
    SearchModel(title: "Usman Fori"),
    SearchModel(title: "Mass Man"), 
  ].obs;
