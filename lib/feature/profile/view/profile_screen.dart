        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              20.height,
              _card(context, Assets.icons.call.svg(),
                  controller.loginModel.value?.phone ?? ""),
              20.height,
              _card(context, Assets.icons.gender.svg(),
                  controller.loginModel.value?.gender ?? ""),
              20.height,
              // _card(context, Assets.icons.dateBirth.svg(),  controller.loginModel.value?.import 'dart:convert';??""),
              //  20.height,
              _card(context, Assets.icons.state.svg(),
                  controller.loginModel.value?.state ?? ""),
              20.height,
              _card(context, Assets.icons.community.svg(),
