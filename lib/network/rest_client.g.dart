...
class _RestClient implements RestClient {
  ...
  @override
  Future<BaseResponse<dynamic>> submitIEVDataNew(
      Map<String, dynamic> request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse<List<String>>> getDesignation() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/Resources/account/designations',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  @override
  Future<BaseResponse<List<String>>> getBanks() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<BaseResponse<dynamic>> postBankAccountDetails(
    dynamic token,
  ...
  Future<BaseResponse<List<BankAccountModel>>> getBankAccountDetails(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<List<BankAccountModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _value = BaseResponse<List<BankAccountModel>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
          ? json
              .map<BankAccountModel>(
                  (i) => BankAccountModel.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    return _value;
  ...
  @override
  Future<BaseResponse<dynamic>> deleteBankDetails(
    dynamic token,
    String accountDetailsId,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'accountDetailId': accountDetailsId
    };
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<BaseResponse<dynamic>> editBankDetails(
    dynamic token,
    String accountDetailsId,
    Map<String, dynamic> reqBody,
  ) async {
  ...
  Future<BaseResponse<String>> generateNumber(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/IEVSurvey/householdnumber/generate',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final _value = BaseResponse<String>.fromJson(
      _result.data!,
      (json) => json as String,
    );
    return _value;
